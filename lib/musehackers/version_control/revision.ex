defmodule Musehackers.VersionControl.Revision do
  ...
  schema "revisions" do
    ...
    belongs_to :parent, Revision, foreign_key: :parent_revision_id
    has_many :children, Revision, foreign_key: :parent_revision_id
  ...
  def changeset(%Revision{} = revision, attrs) do
    revision
    |> cast(attrs, [:id, :message, :hash, :data, :project_id, :parent_revision_id])
