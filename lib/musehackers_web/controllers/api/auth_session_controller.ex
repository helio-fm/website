defmodule MusehackersWeb.Api.AuthSessionController do
  ...
  def init_client_auth_session(%{assigns: %{version: :v1}} = conn, %{"app" => _app_name, "session" => session}) do
  ...
  def finalise_client_auth_session(%{assigns: %{version: :v1}} = conn, %{"app" => app_name, "session" => session}) do
